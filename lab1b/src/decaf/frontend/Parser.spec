...
%tokens
VOID   BOOL  INT   COMPLEX STRING   CLASS	DO OD DOOD
NULL   EXTENDS     THIS     WHILE   FOR	CASE DEFAULT
IF     ELSE        RETURN   BREAK   NEW SUPER PRINT_COMP
...
CaseDef			:	Constant ':' Expr ';'
					{
						$$.stmt = new Tree.Casedef($1.expr, $3.expr, $1.loc);
					}
				;

DefaultExpr		:	DEFAULT ':' Expr ';'
					{
						$$.stmt = new Tree.DefaultCase($3.expr, $1.loc);
					}
				;

DOODStmt		:	DO DOODBranch OD
					{
						$$.stmt = new Tree.DOODStmt($2.slist, $1.loc);
					}
				;

DOODBranch		:	DOODSubStmt DOODSubList
					{
						$$.slist = new ArrayList<Tree>();
						$$.slist.add($1.stmt);
						$$.slist.addAll($2.slist);
				...
				;
DOODSubList		:	DOOD DOODSubStmt DOODSubList
					{
						$$.slist = new ArrayList<Tree>();
						$$.slist.add($2.stmt);
...
DOODSubStmt		:	Expr ':' Stmt
					{
						$$.stmt = new Tree.DOODSubStmt($1.expr, $3.stmt, $1.loc);
					}
				;
