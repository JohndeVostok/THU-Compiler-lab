...
public abstract class Tree {
    ...
    public static final int RE = PRINT + 1;
    public static final int IM = RE + 1;
    public static final int COMPCAST = IM + 1;
    public static final int PRINTCOMP = COMPCAST + 1;
    public static final int DEFAULT = PRINTCOMP + 1;
    public static final int CASELIST = DEFAULT + 1;
    public static final int CASEDEF = CASELIST + 1;
    public static final int DEFAULTCASE = CASEDEF + 1;
    public static final int SUPEREXPR = DEFAULTCASE + 1;
    public static final int DCOPY = SUPEREXPR + 1;
    public static final int SCOPY = DCOPY + 1;
    public static final int DOODSTMT = SCOPY + 1;
    public static final int DOODSUBSTMT = DOODSTMT + 1;
    ...
    public static class Case extends Expr {
        ...
        public Case(Expr expr, List<Tree> slist, Tree stmt, Location loc) {
            super(CASE, loc);
            this.expr = expr;
            this.slist = slist;
            this.stmt = stmt;
    ...
    public static class Casedef extends Expr {
        ...
        public Casedef(int typeTag, Object value, Expr expr, Location loc) {
            super(CASEDEF, loc);
            this.expr = expr;
            this.c = new Literal(typeTag, value, loc);
       }
    ...
    public static class DefaultCase extends Expr {

    	public Expr expr;

        public DefaultCase(Expr expr, Location loc) {
    ...
    public static class DOODStmt extends Tree {

		public List <Tree> slist;

    	public DOODStmt(List <Tree> slist, Location loc) {
    		super(DOODSTMT, loc);
    		this.slist = slist;
    	}
    ...
    public static class DOODSubStmt extends Tree {

		public Expr expr;
		public Tree stmt;

    	public DOODSubStmt(Expr expr, Tree stmt, Location loc) {
    		super(DOODSUBSTMT, loc);
    		this.expr = expr;
    		this.stmt = stmt;
    	}
    ...
    public static abstract class Visitor {
        ...
        public void visitDOODStmt(DOODStmt that) {
			visitTree(that);
        }

        public void visitDOODSubStmt(DOODSubStmt that) {
			visitTree(that);
        }
