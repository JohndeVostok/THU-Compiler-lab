...
%token VOID   BOOL  INT   COMPLEX	STRING  CLASS DO OD DOOD
%token NULL   EXTENDS     THIS     WHILE   FOR   CASE   DEFAULT
%token IF     ELSE        RETURN   BREAK   NEW	 SUPER
%token PRINT  PRINT_COMP	READ_INTEGER         READ_LINE
%token LITERAL DCOPY SCOPY
...
CaseDef			:	Constant ':' Expr ';'
					{
						$$.stmt = new Tree.Casedef($1.typeTag, $1.literal, $3.expr, $1.loc);
					}
				;
